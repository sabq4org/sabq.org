// Pure URL builders for image CDN variants (Cloudflare Images, R2 news
// images, /cdn-cgi transforms). Lives in shared/ because BOTH the SPA
// (OptimizedImage/HeroCarousel/useHeroPreload) and the server
// (edgeMeta.ts homepage hero preload) must generate byte-identical
// srcset/href values — a mismatch makes the browser download the hero twice.
