...
struct AboutAppView: View {
    ...
    var body: some View {
        LegalScaffold(title: L("عن التطبيق"), icon: "info.circle.fill",
                      intro: L("تطبيق VARA الرياضي السعودي يجمع المباريات والبطولات والتوقّعات الذكية في مكانٍ واحد — بتصميمٍ نظيف وأرقام حيّة.")) {
            LegalSection(
                heading: L("من سبق"),
                text: L("تطبيق VARA أحد منتجات صحيفة سبق الإلكترونية. تدخل بعضوية سبق نفسها، وتتابع الرياضة بهوية سعودية من قلب سبق.")
            )
            ...
            LegalSection(heading: L("مصادر البيانات"), text: L("تُجمع نتائج المباريات والإحصاءات من مزوّدي بيانات رياضية متخصّصين، وقد تتأخّر أو تختلف قليلًا عن المصادر الرسمية. وتبقى توقّعات التطبيق تقديرية للمتعة والتحليل فقط."))
...
struct TermsView: View {
    var body: some View {
        LegalScaffold(title: L("شروط الاستخدام"), icon: "doc.text.fill",
            ...
            LegalSection(heading: L("الملكية الفكرية"), text: L("علامة VARA وتصميم التطبيق وواجهاته مملوكة لصحيفة سبق الإلكترونية. لا يجوز نسخها أو إعادة نشرها دون إذن. تبقى حقوق بيانات المباريات لمزوّديها."))
