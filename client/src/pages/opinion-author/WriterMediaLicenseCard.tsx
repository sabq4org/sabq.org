        ...
        <div className="flex items-start gap-3 p-4 sm:p-5">
          ...
          <div className="min-w-0 space-y-2">
            ...
            <p className="text-sm leading-relaxed text-sky-950/90 dark:text-sky-50/90">
              وصلنا ملفك وهو بانتظار موافقة مسؤول النظام بعد الاطلاع على صورة الترخيص.
              لن تتمكن من إنشاء خبر أو مقال حتى تتم الموافقة.
              {data.licenseNumber ? (
                <>
                  {" "}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1 space-y-2.5">
            <div className="space-y-1.5">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                {needsCorrection
                  ? "لن يُحتسب الترخيص سارياً حتى تعيد رفع الملف الصحيح ويُعتمد من مسؤول النظام."
                  : "وفق توجيهات هيئة تنظيم الإعلام، نرجو تزويدنا برقم ترخيصك المهني وتاريخ انتهائه وإرفاق صورة واضحة منه. بعد الإرسال يراجع مسؤول النظام الملف قبل تفعيل الكتابة."}
              </p>
            </div>
