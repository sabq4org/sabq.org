...
/**
 * بانر دعوة لمسابقة التوقّعات داخل هب المونديال — يربط /world-cup/predictions.
 */
export function PredictionsCTA() {
  return (
    <section className="mx-auto max-w-6xl px-3 sm:px-4 py-3">
      <Link
        ...
        data-testid="wc-predictions-cta"
      >
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white/15">
          <Trophy className="h-6 w-6" />
        </div>
        <div className="min-w-0 flex-1">
          <p className="text-base font-black sm:text-lg">شارك في توقّعات المونديال 🏆</p>
          <p className="truncate text-sm text-emerald-50/90">
            توقّع النتيجة الدقيقة واربح من جائزة الـ500 نقطة ولاء لكل مباراة
          </p>
        </div>
