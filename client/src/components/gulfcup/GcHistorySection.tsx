...
/**
 * «سجلّ البطولة» — هوية ليليّة باردة + سكاي (بلا ذهب).
 */
    ...
    <section id="gc-history" dir="rtl" className="relative overflow-hidden py-12">
      ...
      <div className="relative container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-center gap-2">
          ...
          <span className="text-sm text-sky-100/60">منذ 1970</span>
        </div>
        ...
        {holder?.champion && (
          <motion.div
            ...
            className="mb-6 flex items-center gap-4 rounded-3xl border border-sky-300/25 bg-white/[0.06] p-4 backdrop-blur-sm sm:p-5"
          >
            <div className="relative h-16 w-16 shrink-0 rounded-full bg-white p-1.5 shadow-lg ring-2 ring-sky-300/60">
              ...
              <Crown className="absolute -top-2 -left-1 h-5 w-5 text-sky-300 drop-shadow" />
            </div>
            <div className="min-w-0">
              <p className="text-[11px] font-bold text-sky-300/90">حامل اللقب — {holder.title}</p>
              <p className="truncate text-xl font-black text-white">{holder.champion.name}</p>
            ...
            {titles.map((row, i) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-sky-100/70">
                    <span className="font-black tabular-nums text-sky-300">{row.titles}</span>{" "}
          ...
          <div className="-mx-4 overflow-x-auto px-4 pb-2" dir="rtl">
            <div className="flex w-max gap-3">
              {editions.map((e) => (
                ...
                >
                  <p className="text-[11px] font-bold text-sky-100/60">
                    {e.title} · {e.year}
                  </p>
                  {e.upcoming ? (
                    <p className="mt-1.5 text-sm font-black text-sky-300">
                    ...
                    <div className="mt-1.5 flex items-center gap-2">
                      ...
                      <div className="min-w-0">
                        ...
                        {e.finalNote && (
                          <p className="text-[10px] tabular-nums text-sky-100/60" dir="ltr">
                            {e.finalNote}
                          </p>
                        )}
                      </div>
                  ...
                  <p className="mt-1 truncate text-[10px] text-sky-100/50">
