...
interface UrduSmartFilterBarProps {
...
export function UrduSmartFilterBar({ 
  onTimeRangeChange, 
  onMoodChange, 
  onCategoryChange,
  categories = [] 
}: UrduSmartFilterBarProps) {
  ...
  const moodOptions = [
    ...
    { value: 'trending', label: 'رجحان' },
    { value: 'calm', label: 'پرسکون' },
    { value: 'hot', label: 'گرم' },
  ];

  const timeRangeOptions = [
    { value: 'today', label: 'آج' },
    { value: 'week', label: 'اس ہفتے' },
    { value: 'month', label: 'اس مہینے' },
    { value: 'all', label: 'تمام وقت' },
  ];
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="font-semibold">سمارٹ فلٹرز</h3>
