/**
 * لوحة متصدّري توقّعات روشن — نسخة لوحة المونديال (PredictionsLeaderboard):
 * تيجان للمراكز الثلاثة الأولى، صف المستخدم الحالي مميّز، وعدّادات الإصابات
 * الدقيقة والمباريات المحسوبة.
 */
import { Crown, Trophy } from "lucide-react";
import { formatNumber } from "@/lib/format";
import type { LeaderRow, LeaderboardViewer } from "./rslPredictionsTypes";
...
export function RslPredictionsLeaderboard({
  leaders,
  currentUserId,
  isLoading,
  total,
    ...
    <div className="space-y-2">
      ...
      {leaders.map((row) => {
        ...
        return (
          <div
            ...
            data-testid={`rsl-leader-${row.rank}`}
          >
            <div
      ...
      {canLoadMore && (
        <button
          ...
          data-testid="rsl-leaders-load-more"
        >
          {loadingMore
            ? "جارٍ التحميل…"
