...
android {
    ...
    defaultConfig {
        ...
        //   • 10.1.1 (142) — this build (World Cup parity polish: adaptive
        //     theme on detail screens, dual same-time hero cards, home
        //     reorder آراء/مُقترب below latest, عمق section removed)
