...
class ArticleRepository @Inject constructor(
    ...
    /** صفة المراسل من ملفه الموحد (null عند غيابها أو فراغها). */
    suspend fun getReporterTitle(slug: String): String? =
        api.getReporterProfile(slug).title?.trim()?.takeIf { it.isNotEmpty() }
