...
## أولوية الدقة وجودة التنفيذ

- قدّم صحة النتيجة واكتمالها على سرعة التنفيذ وتقليل الاستهلاك.
- استخدم GPT-6 Astra للقيادة، والقرارات المعمارية، والتنفيذ المعقد، وتشخيص الأعطال الغامضة، والمراجعة النهائية، عندما يكون متاحًا.
- استخدم GPT-5.6 Luna للمهام المحددة والواضحة التي يسهل التحقق من نتائجها.
- اختر النموذج وعدد الوكلاء وفق صعوبة المهمة ومخاطرها؛ لا تجعل استخدام Luna أو التوازي إلزاميًا. لا تدّعِ اختيار نموذج أو تفعيل حد تزامن دون تحقق، واذكر القيد إذا لم تسمح البيئة بالاختيار المطلوب.
- حدّد السلوك المطلوب ومعايير القبول قبل التعديل، وافحص الافتراضات المؤثرة في صحة الحل.
- فوّض الأعمال المستقلة فقط، وحدّد لكل وكيل الهدف ونطاق الملفات ومعيار القبول والتحقق المطلوب. احتفظ بالتغييرات شديدة الترابط لدى مسؤول واحد، وتجنب تعديل الملف نفسه من أكثر من وكيل بالتزامن.
- احترم اعتماديات الأنظمة وترتيب المنصات الموضح في هذا الملف؛ التوازي لا يتجاوز هذه المتطلبات ولا يوسّع نطاق المهمة أو صلاحيات الدمج والنشر.
- اطلب مراجعة مستقلة للتغييرات المعقدة أو الحساسة، ويفضل باستخدام Astra. على المراجع فحص الكود والسلوك دون الاكتفاء بتفسير المنفذ. إذا تعذرت المراجعة المستقلة، صرّح بذلك ولا تعرض المراجعة الذاتية باعتبارها مستقلة.
- اختبر النسخة النهائية المجمعة، بما يشمل الحالات الطرفية ومسارات الفشل والتوافق مع السلوك القائم بحسب طبيعة التغيير. في تغييرات الواجهة، افحص النتيجة المعروضة فعليًا.
- لا تعتبر موافقة عدة وكلاء دليلًا على الصحة؛ استند إلى الكود والفحوص والنتائج الفعلية. لا تدّعِ إجراء اختبار لم يُنفذ أو ضمان غياب الأخطاء.
- عالج سبب المشكلة المثبت، وتجنب توسيع التعديل دون حاجة، وحافظ على تغييرات المستخدم القائمة.
- لا تعلن اكتمال العمل مع وجود فشل غير محلول في الفحوص المطلوبة. صرّح بما تعذّر التحقق منه وأثره، واختم بما أُنجز وما اختُبر ونتائجه وما بقي غير متحقق.
...
*آخر تحديث: 2026-09-07 | المسؤول: فريق سبق التقني*
