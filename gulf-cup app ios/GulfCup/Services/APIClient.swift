...
// عميل شبكة عام لتطبيق خليجي 27 — نمط مطابق لـ APIClient في تطبيق سبق لكنه مختصر
// (نقط البطولة عامة بلا مصادقة). يدعم:
...
// الـ actor يعزل حالة التوكن/CSRF (محجوزة للتوقعات لاحقًا). كل الأنواع nonisolated
// لأن SWIFT_DEFAULT_ACTOR_ISOLATION=MainActor على مستوى المشروع.
actor APIClient {
