    ...
    messages: [
      {
        role: "system",
        content:
          "أنت خبير تعريب أسماء لاعبي كرة القدم. ستصلك قائمة بأسماء لاعبين باللاتينية. " +
          "عرّب كل اسم إلى النطق العربي الشائع في التعليق الرياضي العربي (مثل: Mbappé → كيليان مبابي، " +
          "Giroud → أوليفييه جيرو، Di María → أنخيل دي ماريا). حافظ على الاسم الأول + اللقب إن توفّرا. " +
          "لا تترجم معنى الاسم، فقط انقل النطق. أعد JSON فقط بالشكل: " +
          '{"names":[{"src":"<الاسم اللاتيني كما ورد>","ar":"<العربي>"}]}',
      },
