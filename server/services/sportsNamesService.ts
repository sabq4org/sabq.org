...
const TYPE_HINT: Record<SportsNameType, string> = {
  ...
  player:
    ...
    "حرف H في الأسماء السعودية غالبًا هاء لا حاء إن لم يكن اللقب معروفًا بالحاء " +
    "(Hamam Al-Hamami → همام الهمامي، ليس حمام الحمامي)، والياء الأخيرة ياء لا ألف مقصورة (ـي لا ـى)",
};
