...
export const SPL_PLAYER_AR: Record<number, string> = {
  ...
  2627: "محمد الخبراني",
  21486: "بيدرو ريبوشو",
  1609: "كوستاس فورتونيس",
  18881: "جوشوا كينغ",
  // الفتح
  47352: "فيرناندو باتشيكو",
  44589: "أمين البخاري",
  4455: "سفيان بن دبكة",
  // القادسية
  2918: "كوين كاستيلس",
  ...
  203479: "يحيى ناجي",
  // النجمة
  // (لا نجوم مؤكّدون — تُترك للإنجليزية)
  // الخلود
  44347: "حطان باهبري",
  // الرياض
  336: "ميلان بوريان",
  44313: "يحيى الشهري",
  431625: "عبدالإله الخيبري",
  // نيوم
  1470: "لويس ماكسيميانو",
  44329: "محمد البريك",
  19149: "أحمد حجازي",
  44341: "سلمان الفرج",
  19361: "سعيد بن رحمة",
  1467: "ألكسندر لاكازيت",
};

// المدربون الحاليون (مؤكّدون عبر coachs?team — career مفتوح للنادي).
export const SPL_COACH_AR: Record<number, string> = {
  ...
  28645: "غوستافو بوييت",     // الخليج
  94: "جوزيه غوميز",          // الفتح
  995: "ميتشيل",              // القادسية
  8207: "سعد الشهري",         // الاتفاق
  4864: "محمد العبدلي",       // التعاون
  1452: "فاتح تريم",          // الشباب
  2106: "بيدرو إيمانويل",     // الفيحاء
  1177: "صالح المحمدي",       // الحزم
  1174: "خالد العطوي",        // ضمك
  1165: "باولو سيرجيو",       // الأخدود
  5351: "ماريو سيلفا",        // النجمة
  1589: "خافي كاييخا",        // الرياض
  36: "كريستوف غالتييه",      // نيوم
};
