...
export const DEFAULT_FEATURES: DefaultFeature[] = [
  ...
  { featureKey: "newsletter-editorial", displayName: "تحرير سبق في ٣ دقائق", category: "editorial", primary: SONNET, fallbackChain: [GPT_5_1], maxTokens: 3000, temperature: 0.2 },
  ...
  { featureKey: "kings-cup-news", displayName: "أخبار كأس الملك", category: "editorial", primary: GPT_5_1, fallbackChain: CHAIN_AFTER_GPT },
  { featureKey: "saudi-league-story", displayName: "تقرير مباراة الدوري السعودي", category: "sports", primary: GPT_4O_MINI, fallbackChain: CHAIN_AFTER_MINI, maxTokens: 700 },
  { featureKey: "saudi-league-preview", displayName: "معاينة مباراة الدوري السعودي", category: "sports", primary: GPT_4O_MINI, fallbackChain: CHAIN_AFTER_MINI, maxTokens: 600 },
  { featureKey: "sports-snaps", displayName: "لقطات رياضية (VARA)", category: "sports", primary: GPT_4O_MINI, fallbackChain: CHAIN_AFTER_MINI, maxTokens: 600 },
  { featureKey: "sports-intel-scene", displayName: "استخبارات — مشهد المباراة", category: "sports", primary: GPT_4O_MINI, fallbackChain: CHAIN_AFTER_MINI },
  { featureKey: "sports-intel-trends", displayName: "استخبارات — التوجّهات", category: "sports", primary: GPT_4O_MINI, fallbackChain: CHAIN_AFTER_MINI },
  { featureKey: "sports-intel-prediction", displayName: "استخبارات — ترجيح مختصر", category: "sports", primary: GPT_4O_MINI, fallbackChain: CHAIN_AFTER_MINI },
  { featureKey: "sports-intel-digest", displayName: "استخبارات — ملخص يومي", category: "sports", primary: GPT_5_1, fallbackChain: CHAIN_AFTER_GPT },
  { featureKey: "sports-intel-copilot", displayName: "استخبارات — المساعد", category: "sports", primary: GPT_5_1, fallbackChain: CHAIN_AFTER_GPT },
  { featureKey: "sports-intel-match-pre", displayName: "استخبارات — بطاقة ما قبل المباراة", category: "sports", primary: GPT_4O_MINI, fallbackChain: CHAIN_AFTER_MINI },
  { featureKey: "sports-intel-match-live", displayName: "استخبارات — بطاقة مباشرة", category: "sports", primary: GPT_5_1, fallbackChain: CHAIN_AFTER_GPT },
  { featureKey: "sports-intel-match-post", displayName: "استخبارات — بطاقة بعد المباراة", category: "sports", primary: GPT_5_1, fallbackChain: CHAIN_AFTER_GPT },
  ...
  { featureKey: "ifox-quality", displayName: "iFox — فحص الجودة", category: "editorial", primary: GPT_4O_MINI, fallbackChain: CHAIN_AFTER_MINI },
