...
export const SABQ_FEWSHOT_AR = `## أمثلة (قبل/بعد) — نفس مستوى الجودة مهما كان المصدر، دون إضافة أي واقعة غير موجودة فيه

مثال 1 — مصدر ركيك (بريد من جامعة الأمير سلطان): "الجامعة سوت اتفاقيه مع شركة تقنية عشان الطلاب يتدربون على الذكاء الاصطناعي بدأت اليوم"
...
مثال 2 — رسالة واتساب من جامعة الأمير سلطان: "خصم 50% منح جديده بكالوريوس ترجمه للطالبات بالجامعه"
...
مثال 3 — رسالة لا تذكر الجهة: "بدا التسجيل في برنامج تدريب صيفي مجاني لطلاب الثانوي"
...
(المصدر لا يحدد الجهة المنظمة ولا المدينة ولا المواعيد، فلم يُذكر شيء منها. لا تخمّن اسم جهة أو رقماً أو تاريخاً.)`;
