...
const STATIC_INDEXABLE_PAGES: Record<string, { title: string; desc: string; locale?: string; siteName?: string }> = {
  ...
  '/predictions': { title: 'مركز التوقعات — توقّع ونافس على النقاط | سبق', desc: 'توقّع نتائج مباريات دوري روشن وبطولات الخليج ونافس على نقاط البِرك المتراكمة على صحيفة سبق.' },
