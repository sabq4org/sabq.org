> ⚠️ **وثيقة تاريخية — النظام الموصوف هنا حُذف من الخادم في PR ‏#938 (2026-07-17).**
> توقّعات كل البطولات تعمل الآن على **المنصة المركزية Prediction Core** —
> المرجع الحي: `docs/PREDICTION_CORE.md`. أُبقيت هذه الوثيقة أثرًا لفهم قرارات
> التصميم القديمة فقط؛ لا تَبنِ عليها أي كود.
