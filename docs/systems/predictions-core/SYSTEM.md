...
> آخر مراجعة: 2026-09-05 (عرض ركلات الترجيح للمباريات المحسومة بها وتوضيح قواعد مباريات الكؤوس) | المالك: sports
...
## حدود الإغلاق والعملاء — مراجعة 2026-09-05
- كتابة/سحب التوقع داخل transaction تمسك صف المسابقة؛ شرط `clock_timestamp()` عند الكتابة يمنع طلبًا انتظر قفلًا حتى تجاوز الإغلاق.
- تبويبا خليجي وآسيا في أندرويد سبق يستخدمان شاشة المنصة المركزية القائمة؛ توقفت جلبات المحركات المتقاعدة التلقائية. تبقى المجالس والفانتازي على خدماتهما الاجتماعية القائمة.
- لا إعادة تفعيل لمحرك موسمي متقاعد، ولا تغيير في النقاط أو قواعد التسوية أو المونديال.
