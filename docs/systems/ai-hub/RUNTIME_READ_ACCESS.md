...
إصلاح الواجهة المحلي يميز فشل الطلب/استجابة null عن التحميل الأولي، ويتيح إعادة المحاولة، ويبقي آخر بيانات ناجحة مع تنبيه عند فشل التحديث. نجحت ثلاثة اختبارات متصفح محلية ببيانات محاكاة، وفحص TypeScript وESLint. لم يُنشر تعديل الواجهة بعد.
