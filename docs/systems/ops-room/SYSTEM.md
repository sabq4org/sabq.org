...
> آخر مراجعة: 2026-09-05 | المالك: فريق التحرير التقني | **الحالة: تجريبية (prototype) — معزولة عن مسارات الإنتاج**
...
## استعادة التنفيذ — مراجعة 2026-09-05
- صلاحية الخطوة running = startedAt + timeoutMs + مهلة 30 ثانية. الدورة التالية تستعيد المنقطعة عبر مسار المحاولات القائم أو failed بعد استنفادها.
- تحديث الحالة يقارن status/attempts/startedAt في SQL؛ ناتج المحاولة القديمة لا يكتب فوق محاولة جديدة.
- اختيار المهام الأقدم تحديثًا مع تدوير المهام المفحوصة يمنع احتكار أول خمسين مهمة للدورات.
- تبقى بوابات الاعتماد البشري وعدم النشر والإرسال الخارجي كما هي.
