...
- **ليدربورد الجوال وصفحات القوائم (2026-09-11):** الفتحة سطح مكتب فقط. سكربت السكين قد يغرس `#Leaderboard` تحت هيدر الموقع خارج الغلاف `hidden md:block`. القاعدة عند `max-width: 767px` تخفيه بـ `!important`. على `/news` و`/category` (`.news-listing-page` و`.category-listing-page`) تُطوى النسخة المغروسة الفارغة في الديسكتوب أيضاً حتى لا يبقى فراغ فوق رأس الصفحة؛ إن وُجد iframe يبقى الإعلان. MPU للجوال لا يتأثر.
...
## فصل GA4 عن حاوية الإعلانات — 2026-09-13
- Issue #1646: GTM-T5PW84LM مملوك لشركة الإعلانات بتأكيد المستخدم. لا نشر أو تعديل للحاوية ضمن كود المشروع. gtag مستقل بمصدر page_view واحد.
- index.html يحافظ على تأجيل الإعلانات للمحتوى/التفاعل/7 ثوانٍ، ويمنع التحميل الأولي في المضيف/المسار غير المسموح. analytics-ready وحده ليس محفز تحميل. السكربت المحمل سابقًا في SPA يحتاج قواعد الشركة للموافقة والصفحات الحساسة؛ لا ضمان إيقافه من wrapper GA.
- متطلبات الشركة: docs/setup/GOOGLE_TAG_MANAGER_ADS_HANDOFF.md.
