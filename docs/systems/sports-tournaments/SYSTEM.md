...
> آخر مراجعة: 2026-07-27 (تكامل روشن الاحترافي في تطبيق سبق iOS) | المالك: sports
...
- **تكافؤ الويب:** iOS يستهلك نفس `/api/rsl/hero` و`/api/sports/pro-league/*` و`/api/sports/team/:id?with=stats` المستخدمة في `/roshn`؛ الواجهة أصلية للموبايل وليست WebView.
