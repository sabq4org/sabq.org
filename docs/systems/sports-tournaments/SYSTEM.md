...
- **لحظية:** API-Football كثيرًا يبقى على `NS` بعد الانطلاق في الودّيات. نستثني ودّيات الأندية السعودية من ضجيج لوحة TheSports، ونُركّب النتيجة/الحالة بالأسماء على مركز المباراة ولوحة اليوم/المباشر؛ إن تعذّر: تسمية «موعد الانطلاق مرّ — بانتظار التغطية».
