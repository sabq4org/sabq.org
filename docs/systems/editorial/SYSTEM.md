...
> آخر مراجعة: 2026-07-20 (تنبيه تجديد الترخيص قبل شهرين) | المالك: editorial
...
- **إدارة الترخيص من صفحة الكتّاب:** `/dashboard/opinion-writers` تعرض (ساري / منتهٍ / غير مرخّص) مع تاريخ الانتهاء وفلترة وبحث وزر «عرض الملف» عبر `GET /api/admin/opinion-writers/:writerId/media-license-file`.
