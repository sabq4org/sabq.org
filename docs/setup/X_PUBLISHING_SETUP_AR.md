...
- حد النص: منذ 2026-08-07 الرفض الفعلي عند **25,000** وحدة موزونة
  (حسابات Premium/التوثيق المؤسسي — حال @sabqorg)، و**280** عتبة إرشادية
  يتحول العداد بعدها كهرمانياً («يظهر مطوياً») — العربية = 1/حرف، الروابط = 23.
  حساب بلا Premium سيرفضه X عند النشر برسالة واضحة في سجل المحاولات.
