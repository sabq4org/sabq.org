...
| Android QA `com.sabqorg.sabq.dev` | `1:534820013195:android:5287c6c9eacf65d0bdc08e` | `src/debug/google-services.json` مدمج للاختبار فقط |
...
4. استخدم إعداد Android QA المطابق للـsuffix للاختبار. لا تستعر ملف VARA ولا تستخدم Application ID وهميًا. لا تُدخل إعداد Android Release قبل حل اختلاف مشروع FCM الإنتاجي.
