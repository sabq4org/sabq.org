...
- تعليمات المزوّد تحجز استدعاءات لفتح كل مصدر برابطه الكامل منفردًا، بعد استعلام أو اثنين للاكتشاف واستعلام ثالث احتياطي للبدائل، ضمن سقف 8 استدعاءات. يكفي 1–3 مصادر مقروءة؛ لا تُهدر المحاولات على موقع يعيد عنوانًا بلا متن. إذا لم تتوفر مصادر مقروءة، تنتهي المهمة برسالة محددة تطلب رابطًا متاحًا دون توليد تقرير. فشل المطابقة يسجل عدد المصادر والمصادر غير المطابقة والروابط المفتوحة واستدعاءات البحث فقط.
